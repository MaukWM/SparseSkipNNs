...
class Visualizer:
    ...
    def plot_k_evolution_graphs(self):
        ...
        k_n_dists_LD = self.trainer_items[ItemKey.K_N_DISTRIBUTION.value]
        k_sparsity_dists_LD = self.trainer_items[ItemKey.K_SPARSITY_DISTRIBUTION.value]
        k_sparsity_by_max_seq_dists_LD = self.trainer_items[ItemKey.K_SPARSITY_DISTRIBUTION_BY_MAX_SEQ.value]
    ...
    def plot_k_distribution(self):
        ...
        k_n_dists = self.trainer_items[ItemKey.K_N_DISTRIBUTION.value]
        ...
        k_sparsity_dists = self.trainer_items[ItemKey.K_SPARSITY_DISTRIBUTION.value]
        ...
        k_sparsity_by_max_seq_dists = self.trainer_items[ItemKey.K_SPARSITY_DISTRIBUTION_BY_MAX_SEQ.value]
